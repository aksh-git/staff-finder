...
function AddNewFieldBtn(props) {
  ...
  return (
    <div
      onClick={()=>action()}
      className='cursor-pointer float-right inline-flex items-center gap-2 border bottom-1 px-4 py-1 text-sm font-semibold bg-bodyBg text-gray-600 rounded-3xl'    
    >
